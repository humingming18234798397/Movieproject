...
public class TwoAdaprer extends BaseRecyclerAdapter<ShangYingBean.ResultBean> {
    public TwoAdaprer(Context context) {
        super(context);
    ...
    @Override
    public void bindViewDataPosition(BaseViewHolder baseViewHolder, ShangYingBean.ResultBean resultBean, int i) {
    ...
    @Override
    public void bindViewData(BaseViewHolder baseViewHolder, ShangYingBean.ResultBean resultBean) {
